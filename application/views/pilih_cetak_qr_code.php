			...
			<div class="col-md-12 col-sm-12  ">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="col-md-6">
							<div class="card-body">
							<a href="<?=base_url();?>menu/cetak_qr_code" target="_blank">CETAK</a>
								<p>
									<font size="5" class="card-title"><?= $user['nama']; ?></font>
								<p>
								<p>
									<font size="4" class="card-text ml-1"><?= $user['email']; ?></font>
								</p>
								<p>
									<font size="2" class="card-text text-mute ml-1">
